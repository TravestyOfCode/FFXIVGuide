...
public class CreateNoteValidation : IPipelineBehavior<CreateNote, Result<NoteModel>>
{
    private readonly ApplicationDBContext _dbContext;

    private readonly ILogger<CreateNoteValidation> _logger;

    public CreateNoteValidation(ApplicationDBContext dbContext, ILogger<CreateNoteValidation> logger)
    {
